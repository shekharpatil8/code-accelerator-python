...
class TestBook(unittest.TestCase):
    ...
    def setUp(self):
        self.data = TestDataGenerator.generate_sample_data(Book)
        self.instance = Book(**self.data)
    ...
    def test_valid_data(self):
        ...
        valid_data = TestDataGenerator.generate_sample_data(Book)
        instance = Book(**valid_data)
    ...
    def test_from_dict_with_none(self):
        ...
        self.assertIsNone(Book.from_dict(None))
    
    def test_from_dict_with_invalid_type(self):
        """Test from_dict with non-dict input"""
        with self.assertRaises(ValidationError):
            Book.from_dict("invalid")
    
    def test_invalid_data(self):
        """Test validation errors on invalid data"""
        invalid_data = TestDataGenerator.generate_invalid_data(Book)
        with self.assertRaises(ValidationError):
            Book(**invalid_data)
    
    def test_to_str(self):
        """Test string representation"""
        obj = Book.from_dict(self.data)  # Convert dict to object
